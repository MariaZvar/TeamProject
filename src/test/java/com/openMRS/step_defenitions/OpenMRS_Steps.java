...
//    ReportsPage reportsPage=new ReportsPage(driver);
    ...
    public void user_provide_user_name_and_password(io.cucumber.datatable.DataTable dataTable) {
    ...
    public void user_provide_wrong_and(io.cucumber.datatable.DataTable dataTable) {
    ...
    public void user_click_in_login_btn_validate_text_of(io.cucumber.datatable.DataTable dataTable) {
