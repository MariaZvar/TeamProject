...
//Alena -active visits
    ...
    public void user_enters_all_the_valid_information_like(String givenName, String familyName, String day, String month, String year, String address, String country, String state, String city, String zipcode, String phone) {
        registerPatientPage.registerPatient( givenName, familyName, day, month, year, address, country, state, city, zipcode, phone);
        registerPatientPage.patientId();
    }
...
mainPage.findPatientRecordClick();
    ...
    public void user_makes_sure_search_bar_is_displayed_and_clear_button_is_displayed() throws InterruptedException {
        findPatientRecordPage.validateSearchClearBtn();
        findPatientRecordPage.validateClearBtn("abcd");
        findPatientRecordPage.setLogout();
